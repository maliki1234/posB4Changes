...
export default function ReportFooter({ pro , day }) {
  ...
  return (
    <>
      <Card className="fixed w-10/12 py-2 grid grid-cols-1 md:grid-cols-5 bottom-0">
          ...
          <div className="px-2">
            <Dialog>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  <DialogTitle className="text-uppercase text-center">leo  mini market</DialogTitle>
