        ...
        CredentialsProvider({
          ...
          async authorize(credentials) {
            ...
            return {
              ...
              Business: existingUser.Business?.name ?? null,
              BusinessInfo: existingUser.Business
            }
            },
      ...
      callbacks:{
        async jwt({token , user}){
          ...
          if (user) {
            ...
            return {
              ...
              id: user.id,
              active: user.active,
              Bussiness: user? user.Business : undefined,
        ...
        // console.log(session)
          return {
            ...
            id: token.id,
            active: token.active,
            Business: token.Bussiness,
            BusinessInfo: token.BusinessInfo
